...
const ADMIN_USER = 'donelclasico'
const ADMIN_PASS = 'password'
const SESSION_KEY = 'de_admin_session'
...
function setSession() {
  sessionStorage.setItem(SESSION_KEY, JSON.stringify({ valid: true }))
}

function LoginGate({ isLight, onThemeToggle, onSuccess }) {
    ...
    <div className="login-gate-page">
      ...
      <div className="login-gate">
        ...
        <div className="login-card">
          ...
          <h1 className="login-title">Owner<br /><em>Portal.</em></h1>
          <p className="login-sub">Enter your credentials to manage the collection.</p>
          <form className="login-form" onSubmit={handleSubmit} noValidate>
            ...
            <button type="submit" className="btn-primary" disabled={loading}>
              <span>{loading ? 'Checking…' : 'Enter Portal'}</span>
              {loading && (
