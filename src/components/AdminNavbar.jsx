...
export default function AdminNavbar({
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-[68px] max-w-[1400px] mx-auto">

        {/* ── Brand ─────────────────────────────────────────────────────── */}
        <div className="flex items-center gap-[10px]">
          <LogoSVG className="h-7 w-7 shrink-0 text-[var(--white)]" />
          <span
            className="text-[1rem] font-bold tracking-[0.35em] uppercase text-[var(--white)]"
            style={{ fontFamily: 'var(--font-display)' }}
          >
            DON ELCLASICO
          </span>
          {/* Admin badge */}
          <span className="text-[0.55rem] tracking-[0.3em] uppercase text-[var(--accent)] border border-[var(--border)] px-2 py-[3px] ml-2 leading-none">
            Admin
          </span>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <a
            href={siteHref}
            className="flex items-center gap-[6px] text-[0.65rem] tracking-[0.25em] uppercase text-[var(--text-muted)] transition-colors duration-300 hover:text-[var(--accent)]"
          >
            <ArrowLeftIcon />
            View Site
          </a>
          ...
          <button
            onClick={onLogout}
            className="flex items-center gap-2 text-[0.65rem] tracking-[0.2em] uppercase text-[var(--text-muted)] px-[14px] py-[6px] border border-[var(--border)] transition-all duration-300 hover:text-[#c0392b] hover:border-[#c0392b]"
          >
            <LogoutIcon />
            Logout
          </button>
